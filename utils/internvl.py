...
class InternvlTemplate(Template):
    ...
    def _post_encode(self, model: nn.Module, inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # print("swift_inputs_embeds.shape:",inputs_embeds.shape)  # 4-2336-4096
        text_features = inputs_embeds.clone().to(device=device)
        # print("swift_text_features.shape:",text_features.shape)   # 4-2336-4096
        ...
        if pixel_values is not None:
            ...
            # print("swift_vit_embeds.shape", vit_embeds.shape)  # 32-256-4096
            selected = (input_ids == self.processor.encode('<IMG_CONTEXT>', add_special_tokens=False)[0])
            # print("swift_selected.shape",selected.shape)  # 4-2336
            ...
            # print("swift_text_features.shape", text_features.shape)  # 4-288-4096
            ...
            # print("swift_vit_embeds.shape", vit_embeds.shape)  # 4-2048-4096
